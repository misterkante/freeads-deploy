<header>
        <nav class="p-4 flex justify-between items-center w-full fixed bg-white shadow shadow-white">
            <div class="flex items-center font-bold">
                ...
                <h1 class="text-indigo-400 text-xl ml-3 uppercase">FreeAds</h1>
            </div>
            {{--  --}}
            <form class="w-full md:w-2/5" action="index.php" method="post">
                <div class="flex">
