    ...
    <div class="flex bg-white p-10 shadow-2xl rounded-xl">
      <form action="{{ route('login') }}" class="mx-auto max-w-sm" method="POST">
        ...
        <div class="mb-5">
          ...
          <input name="email" type="email" id="email" value="{{ old('email') }}" class="w-full rounded-lg border border-gray-300 p-2.5 text-md text-gray-900" placeholder="john.doe@company.com" required/>
          @if ($errors->has('email'))
        ...
        <div class="mb-5">
          ...
          <input name="password" type="password" id="password" class="w-full rounded-lg border border-gray-300 p-2.5 text-md text-gray-900" placeholder="........" required/>
